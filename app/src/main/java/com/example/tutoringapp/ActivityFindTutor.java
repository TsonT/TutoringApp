...
public class ActivityFindTutor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Dialog loadDialog = loadingDialog.create(this, "Loading...");
        loadDialog.show();

        recyclerview_Tutors = findViewById(R.id.recyclerview_Tutors);
        ...
        btn_Filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ActivityFindTutor.this);
        ...
        field_SearchName = findViewById(R.id.field_SearchName);
        ...
        mTutorInfo.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                RecyclerViewAdapterTutorProfile adapter = new RecyclerViewAdapterTutorProfile(ActivityFindTutor.this, tutorProfileArrayList);
                recyclerview_Tutors.setLayoutManager(new GridLayoutManager(ActivityFindTutor.this, 3));
    ...
    public void startSearch()
    {
        ...
        else
        {
            ...
            RecyclerViewAdapterTutorProfile adapter = new RecyclerViewAdapterTutorProfile(ActivityFindTutor.this, filteredArrayList);
            recyclerview_Tutors.setAdapter(adapter);

            if (filteredArrayList.size() == 0)
            {
                Toast.makeText(this, "Sorry Could Not Find A Tutor Meeting Those Requirements", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
